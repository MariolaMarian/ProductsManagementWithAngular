        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(maxLength: 100, nullable: false),
                    Barecode = table.Column<string>(maxLength: 13, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CollectedById = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpirationDates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExpirationDates_AspNetUsers_CollectedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpirationDates_CollectedById",
